...
$conn = new mysqli($server, $username, $password, $database);
    ...
    if ($conn->connect_error) {
        ...
        $query = "insert into $table (full_name,f_name,m_name,dob,grade,gender,address,religion,nationality,email,phone,r_no)
         values ('$full_name','$f_name','$m_name', '$dob','$grade','$gender','$address','$religion','$nationality','$email',
         '$phone','$r_no')";
