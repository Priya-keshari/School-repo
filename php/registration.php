...
<body style="background-color: rgb(198, 155, 198)">
    ...
    if ($conn->connect_error) {
        ...
        $query = "insert into $table (fname,lname,dob,gender,grade,langs,father_name,f_qualification,f_mob,
        f_occupation,mother_name,m_qualification,m_mob,m_occupation,address,payment) values ('$fname',
        '$lname','$dob','$gender','$grade','$langs','$father_name','$f_qualification','$f_mob','$f_occupation',
        '$mother_name','$m_qualification','$m_mob','$m_occupation','$address','$payment')";
